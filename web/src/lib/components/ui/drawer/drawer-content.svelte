...
<DrawerPortal {...portalProps}>
  ...
  <DrawerPrimitive.Content
    class={cn(
      "group/drawer-content bg-stone-900 fixed z-50 flex h-auto flex-col border-stone-700",
  ...
  >
    <div
      class="bg-stone-700 mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
    ></div>
    {@render children?.()}
  </DrawerPrimitive.Content>
</DrawerPortal>
