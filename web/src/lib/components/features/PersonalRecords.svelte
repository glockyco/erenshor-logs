...
<div class="bg-stone-800 border-2 border-stone-700 rounded-lg shadow-lg">
  <div class="border-b border-stone-700 px-6 py-4">
    <div class="flex items-center justify-between">
      <Heading variant="section">Personal Records</Heading>
      <span
  ...
  <div class="p-6">
    <div class="py-12 text-center">
      <p class="text-sm text-stone-500">
        Track your highest DPS, longest fight, fastest kill, and more
      </p>
      <p class="mt-2 text-xs text-stone-600">Feature planned for Issue #88</p>
    </div>
  </div>
</div>
